...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Ll(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(t,i).enumerable})),n.push.apply(n,r)}return n}function Vl(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?Ll(Object(n),!0).forEach(function(r){Oy(t,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):Ll(Object(n)).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(n,r))})}return t}function Ly(t){return Dy(t)||Ny(t)||$y(t)||My()}function Vy(t,e){if(typeof t!="object"||!t)return t;var n=t[Symbol.toPrimitive];if(n!==void 0){var r=n.call(t,e);if(typeof r!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}function Fy(t){var e=Vy(t,"string");return typeof e=="symbol"?e:e+""}function $y(t,e){if(t){if(typeof t=="string")return ea(t,e);var n={}.toString.call(t).slice(8,-1);return n==="Object"&&t.constructor&&(n=t.constructor.name),n==="Map"||n==="Set"?Array.from(t):n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?ea(t,e):void 0}}var Fl={activateTrap:function(e,n){if(e.length>0){var r=e[e.length-1];r!==n&&r._setPausedState(!0)}var i=e.indexOf(n);i===-1||e.splice(i,1),e.push(n)},deactivateTrap:function(e,n){var r=e.indexOf(n);r!==-1&&e.splice(r,1),e.length>0&&!e[e.length-1]._isManuallyPaused()&&e[e.length-1]._setPausedState(!1)}},jy=function(e){return e.tagName&&e.tagName.toLowerCase()==="input"&&typeof e.select=="function"},Uy=function(e){return e?.key==="Escape"||e?.key==="Esc"||e?.keyCode===27},Rr=function(e){return e?.key==="Tab"||e?.keyCode===9},zy=function(e){return Rr(e)&&!e.shiftKey},By=function(e){return Rr(e)&&e.shiftKey},$l=function(e){return setTimeout(e,0)},Er=function(e){for(var n=arguments.length,r=new Array(n>1?n-1:0),i=1;i<n;i++)r[i-1]=arguments[i];return typeof e=="function"?e.apply(void 0,r):e},Pi=function(e){return e.target.shadowRoot&&typeof e.composedPath=="function"?e.composedPath()[0]:e.target},Wy=[],Nf=function(e,n){var r=n?.document||document,i=n?.trapStack||Wy,o=Vl({returnFocusOnDeactivate:!0,escapeDeactivates:!0,delayInitialFocus:!0,isKeyForward:zy,isKeyBackward:By},n),s={containers:[],containerGroups:[],tabbableGroups:[],nodeFocusedBeforeActivation:null,mostRecentlyFocusedNode:null,active:!1,paused:!1,manuallyPaused:!1,delayInitialFocusTimer:void 0,recentNavEvent:void 0},a,c=function(f,C,N){return f&&f[C]!==void 0?f[C]:o[N||C]},l=function(f,C){var N=typeof C?.composedPath=="function"?C.composedPath():void 0;return s.containerGroups.findIndex(function(V){var F=V.container,G=V.tabbableNodes;return F.contains(f)||N?.includes(F)||G.find(function(L){return L===f})})},d=function(f){var C=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},N=C.hasFallback,V=N===void 0?!1:N,F=C.params,G=F===void 0?[]:F,L=o[f];if(typeof L=="function"&&(L=L.apply(void 0,Ly(G))),L===!0&&(L=void 0),!L){if(L===void 0||L===!1)return L;throw new Error("`".concat(f,"` was specified but was not a node, or did not return a node"))}var Y=L;if(typeof L=="string"){try{Y=r.querySelector(L)}catch(J){throw new Error("`".concat(f,'` appears to be an invalid selector; error="').concat(J.message,'"'))}if(!Y&&!V)throw new Error("`".concat(f,"` as selector refers to no known node"))}return Y},u=function(){var f=d("initialFocus",{hasFallback:!0});if(f===!1)return!1;if(f===void 0||f&&!bs(f,o.tabbableOptions))if(l(r.activeElement)>=0)f=r.activeElement;else{var C=s.tabbableGroups[0],N=C&&C.firstTabbableNode;f=N||d("fallbackFocus")}else f===null&&(f=d("fallbackFocus"));if(!f)throw new Error("Your focus-trap needs to have at least one focusable element");return f},h=function(){if(s.containerGroups=s.containers.map(function(f){var C=Cy(f,o.tabbableOptions),N=Ry(f,o.tabbableOptions),V=C.length>0?C[0]:void 0,F=C.length>0?C[C.length-1]:void 0,G=N.find(function(J){return Bn(J)}),L=N.slice().reverse().find(function(J){return Bn(J)}),Y=!!C.find(function(J){return bn(J)>0});return{container:f,tabbableNodes:C,focusableNodes:N,posTabIndexesFound:Y,firstTabbableNode:V,lastTabbableNode:F,firstDomTabbableNode:G,lastDomTabbableNode:L,nextTabbableNode:function(te){var le=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!0,be=C.indexOf(te);return be<0?le?N.slice(N.indexOf(te)+1).find(function(et){return Bn(et)}):N.slice(0,N.indexOf(te)).reverse().find(function(et){return Bn(et)}):C[be+(le?1:-1)]}}}),s.tabbableGroups=s.containerGroups.filter(function(f){return f.tabbableNodes.length>0}),s.tabbableGroups.length<=0&&!d("fallbackFocus"))throw new Error("Your focus-trap must have at least one container with at least one tabbable node in it at all times");if(s.containerGroups.find(function(f){return f.posTabIndexesFound})&&s.containerGroups.length>1)throw new Error("At least one node with a positive tabindex was found in one of your focus-trap's multiple containers. Positive tabindexes are only supported in single-container focus-traps.")},_=function(f){var C=f.activeElement;if(C)return C.shadowRoot&&C.shadowRoot.activeElement!==null?_(C.shadowRoot):C},k=function(f){if(f!==!1&&f!==_(document)){if(!f||!f.focus){k(u());return}f.focus({preventScroll:!!o.preventScroll}),s.mostRecentlyFocusedNode=f,jy(f)&&f.select()}},E=function(f){var C=d("setReturnFocus",{params:[f]});return C||(C===!1?!1:f)},T=function(f){var C=f.target,N=f.event,V=f.isBackward,F=V===void 0?!1:V;C=C||Pi(N),h();var G=null;if(s.tabbableGroups.length>0){var L=l(C,N),Y=L>=0?s.containerGroups[L]:void 0;if(L<0)F?G=s.tabbableGroups[s.tabbableGroups.length-1].lastTabbableNode:G=s.tabbableGroups[0].firstTabbableNode;else if(F){var J=s.tabbableGroups.findIndex(function(zt){var We=zt.firstTabbableNode;return C===We});if(J<0&&(Y.container===C||bs(C,o.tabbableOptions)&&!Bn(C,o.tabbableOptions)&&!Y.nextTabbableNode(C,!1))&&(J=L),J>=0){var te=J===0?s.tabbableGroups.length-1:J-1,le=s.tabbableGroups[te];G=bn(C)>=0?le.lastTabbableNode:le.lastDomTabbableNode}else Rr(N)||(G=Y.nextTabbableNode(C,!1))}else{var be=s.tabbableGroups.findIndex(function(zt){var We=zt.lastTabbableNode;return C===We});if(be<0&&(Y.container===C||bs(C,o.tabbableOptions)&&!Bn(C,o.tabbableOptions)&&!Y.nextTabbableNode(C))&&(be=L),be>=0){var et=be===s.tabbableGroups.length-1?0:be+1,Pe=s.tabbableGroups[et];G=bn(C)>=0?Pe.firstTabbableNode:Pe.firstDomTabbableNode}else Rr(N)||(G=Y.nextTabbableNode(C))}}else G=d("fallbackFocus");return G},A=function(f){var C=Pi(f);if(!(l(C,f)>=0)){if(Er(o.clickOutsideDeactivates,f)){a.deactivate({returnFocus:o.returnFocusOnDeactivate});return}Er(o.allowOutsideClick,f)||f.preventDefault()}},x=function(f){var C=Pi(f),N=l(C,f)>=0;if(N||C instanceof Document)N&&(s.mostRecentlyFocusedNode=C);else{f.stopImmediatePropagation();var V,F=!0;if(s.mostRecentlyFocusedNode)if(bn(s.mostRecentlyFocusedNode)>0){var G=l(s.mostRecentlyFocusedNode),L=s.containerGroups[G].tabbableNodes;if(L.length>0){var Y=L.findIndex(function(J){return J===s.mostRecentlyFocusedNode});Y>=0&&(o.isKeyForward(s.recentNavEvent)?Y+1<L.length&&(V=L[Y+1],F=!1):Y-1>=0&&(V=L[Y-1],F=!1))}}else s.containerGroups.some(function(J){return J.tabbableNodes.some(function(te){return bn(te)>0})})||(F=!1);else F=!1;F&&(V=T({target:s.mostRecentlyFocusedNode,isBackward:o.isKeyBackward(s.recentNavEvent)})),k(V||s.mostRecentlyFocusedNode||u())}s.recentNavEvent=void 0},S=function(f){var C=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!1;s.recentNavEvent=f;var N=T({event:f,isBackward:C});N&&(Rr(f)&&f.preventDefault(),k(N))},R=function(f){(o.isKeyForward(f)||o.isKeyBackward(f))&&S(f,o.isKeyBackward(f))},P=function(f){Uy(f)&&Er(o.escapeDeactivates,f)!==!1&&(f.preventDefault(),a.deactivate())},I=function(f){var C=Pi(f);l(C,f)>=0||Er(o.clickOutsideDeactivates,f)||Er(o.allowOutsideClick,f)||(f.preventDefault(),f.stopImmediatePropagation())},g=function(){if(s.active)return Fl.activateTrap(i,a),s.delayInitialFocusTimer=o.delayInitialFocus?$l(function(){k(u())}):k(u()),r.addEventListener("focusin",x,!0),r.addEventListener("mousedown",A,{capture:!0,passive:!1}),r.addEventListener("touchstart",A,{capture:!0,passive:!1}),r.addEventListener("click",I,{capture:!0,passive:!1}),r.addEventListener("keydown",R,{capture:!0,passive:!1}),r.addEventListener("keydown",P),a},p=function(){if(s.active)return r.removeEventListener("focusin",x,!0),r.removeEventListener("mousedown",A,!0),r.removeEventListener("touchstart",A,!0),r.removeEventListener("click",I,!0),r.removeEventListener("keydown",R,!0),r.removeEventListener("keydown",P),a},m=function(f){var C=f.some(function(N){var V=Array.from(N.removedNodes);return V.some(function(F){return F===s.mostRecentlyFocusedNode})});C&&k(u())},v=typeof window<"u"&&"MutationObserver"in window?new MutationObserver(m):void 0,b=function(){v&&(v.disconnect(),s.active&&!s.paused&&s.containers.map(function(f){v.observe(f,{subtree:!0,childList:!0})}))};return a={get active(){return s.active},get paused(){return s.paused},activate:function(f){if(s.active)return this;var C=c(f,"onActivate"),N=c(f,"onPostActivate"),V=c(f,"checkCanFocusTrap");V||h(),s.active=!0,s.paused=!1,s.nodeFocusedBeforeActivation=_(r),C?.();var F=function(){V&&h(),g(),b(),N?.()};return V?(V(s.containers.concat()).then(F,F),this):(F(),this)},deactivate:function(f){if(!s.active)return this;var C=Vl({onDeactivate:o.onDeactivate,onPostDeactivate:o.onPostDeactivate,checkCanReturnFocus:o.checkCanReturnFocus},f);clearTimeout(s.delayInitialFocusTimer),s.delayInitialFocusTimer=void 0,p(),s.active=!1,s.paused=!1,b(),Fl.deactivateTrap(i,a);var N=c(C,"onDeactivate"),V=c(C,"onPostDeactivate"),F=c(C,"checkCanReturnFocus"),G=c(C,"returnFocus","returnFocusOnDeactivate");N?.();var L=function(){$l(function(){G&&k(E(s.nodeFocusedBeforeActivation)),V?.()})};return G&&F?(F(E(s.nodeFocusedBeforeActivation)).then(L,L),this):(L(),this)},pause:function(f){return s.active?(s.manuallyPaused=!0,this._setPausedState(!0,f)):this},unpause:function(f){return s.active?(s.manuallyPaused=!1,i[i.length-1]!==this?this:this._setPausedState(!1,f)):this},updateContainerElements:function(f){var C=[].concat(f).filter(Boolean);return s.containers=C.map(function(N){return typeof N=="string"?r.querySelector(N):N}),s.active&&h(),b(),this}},Object.defineProperties(a,{_isManuallyPaused:{value:function(){return s.manuallyPaused}},_setPausedState:{value:function(f,C){if(s.paused===f)return this;if(s.paused=f,f){var N=c(C,"onPause"),V=c(C,"onPostPause");N?.(),p(),b(),V?.()}else{var F=c(C,"onUnpause"),G=c(C,"onPostUnpause");F?.(),h(),g(),b(),G?.()}return this}}}),a.updateContainerElements(e),a};const ec=Je(!1),li=({modalContent:t,setIsVisible:e,isVisible:n,refer:r})=>{const[i,o]=B();return j(()=>{r.current&&o(Nf(r.current))},[r]),j(()=>{n?i?.activate():i?.deactivate()},[n,i]),y("div",{role:"presentation",id:"overlay",class:n?"fixed inset-0 z-20 flex items-center justify-center bg-slate-50/70 backdrop-blur-[1px] transition-opacity duration-200 dark:bg-slate-900/70":"h-0 w-0 opacity-0",onKeyDown:s=>{s.key==="Escape"&&e(!1)},children:y("div",{id:"modal-window",ref:r,class:n?"dark:(bg-slate-600, shadow-slate-700) flex w-80 flex-col rounded bg-slate-300 shadow-sm shadow-slate-200 transition-all sm:w-96 md:w-[28rem] lg:w-[32rem] xl:w-[36rem] 2xl:w-[40rem]":"hidden",children:[y("div",{class:"mx-4 my-2 flex justify-between text-xl font-semibold text-violet-900 transition-all select-none xl:text-2xl dark:text-pink-300",children:[t?.key,y("button",{type:"button",id:"close-modal",class:"hover:(bg-slate-200, active:bg-slate-100, dark:(bg-slate-700, active:bg-slate-800)) rounded px-1 leading-4 transition-colors xl:px-2",onClick:()=>{e(!1)},children:y(Sf,{"aria-label":"X",strokeWidth:"2.5",class:"scale-105 transition-transform xl:scale-125"})})]}),y("div",{id:"modal-content",class:"dark:(bg-slate-700, text-slate-50) mx-px mb-px grow rounded-b bg-slate-200 px-4 py-3 text-slate-900",children:y(ec.Provider,{value:n,children:t})})]})})},$o=({id:t,handleCancel:e})=>y("button",{type:"button",id:t,class:"hover:(bg-slate-100, active:(bg-slate-50), dark:(bg-slate-800, active:bg-slate-900)) md:(w-24, py-2) xl:(w-32, py-2.5, text-xl) max-h-[3rem] w-20 rounded py-1.5 text-lg font-medium transition-all lg:w-28",onClick:e,children:"Cancel"}),jo=({id:t,action:e,styleClass:n,isDisabled:r=!1,isLoading:i=!1,handleConfirm:o})=>y("button",{type:"button",id:t,class:`${n} ${r||i?"cursor-not-allowed !bg-slate-500":""} md:(w-24, py-2) xl:(w-32, py-2.5, text-xl) max-h-[3rem] w-20 rounded py-1.5 text-lg font-medium text-white transition-all lg:w-28`,disabled:r||i,onClick:()=>void o(),children:i?y(Z0,{"aria-label":"Loader Circle",strokeWidth:"2.25",class:"inline-block scale-110 animate-spin"}):e}),Hy="Service Worker Register failed.",jl="Sort failed.",oo="Project Add failed.",Ul="Project Save failed.",zl="Project Delete failed.",Bl="Todo Add failed.",Wl="Todo Save failed.",Hl="Todo Delete failed.",ql="Login failed.",Gl="Logout failed.",so="Sync failed.",Mf="Project Added!",qy="Project Saved!",Gy="Project Deleted!",Ky="Todo Added!",Yy="Todo Saved!",Jy="Todo Deleted!",Xy="You're Logged In!",Qy="You're Logged Out!",Lf="Data Synced!",jt=$g,Ee=zg;/**
 * @license
...
</defs>`,k.innerText="Preview backend running in this workspace."),k.setAttribute("id",_)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",u):u()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H_{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(q_(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function q_(t){return t.getComponent()?.type==="VERSION"}const ra="@firebase/app",eu="0.14.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
