...
export const Header = (): JSX.Element => {
  return (
    <header class='lg:(flex-row, justify-between, gap-4, px-6, py-4) dark:(bg-slate-800, text-pink-500, border-slate-700) xl:(py-2, text-4xl) flex select-none items-center justify-center border-b border-slate-200 bg-slate-100 p-4 pt-16 text-3xl font-bold text-violet-800 transition-all'>
      <span
        id='logo'
